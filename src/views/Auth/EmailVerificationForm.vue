  ...
  methods: {
    ...
    async resendVerificationCode() {
      ...
      try {
        ...
        localStorage.setItem("kdad_admin_dashboard_verification_code", res.data.body.code);
    ...
    async submitForm() {
      ...
      if (this.verificationType == "reset-password") {
        try {
          ...
          localStorage.setItem("kdad_admin_dashboard_forget_pass_token", res.data.data.access_token);
          this.$message.success(this.$t("MESSAGES.verifiedSuccessfully"));
          this.clearFormInputs();
          localStorage.removeItem("kdad_admin_dashboard_verification_code");
          localStorage.removeItem("kdad_admin_dashboard_email");
