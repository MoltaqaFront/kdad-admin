  ...
  methods: {
    ...
    async getDataToEdit() {
      try {
        ...
        // Start:: Set Data
        this.data.contentAr = res.data.data.about_app_ar;
        this.data.contentEn = res.data.data.about_app_en;
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("about_app[ar]", this.data.contentAr);
      REQUEST_DATA.append("about_app[en]", this.data.contentEn);
