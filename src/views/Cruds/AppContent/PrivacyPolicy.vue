  ...
  methods: {
    ...
    async getDataToEdit() {
      try {
        ...
        // Start:: Set Data
        this.data.contentAr = res.data.data.privacy_policy_ar;
        this.data.contentEn = res.data.data.privacy_policy_en;
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("privacy_policy[ar]", this.data.contentAr);
      REQUEST_DATA.append("privacy_policy[en]", this.data.contentEn);
