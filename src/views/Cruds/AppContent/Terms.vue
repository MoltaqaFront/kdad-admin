  ...
  methods: {
    ...
    async getDataToEdit() {
      try {
        ...
        // Start:: Set Data
        this.data.contentAr = res.data.data.terms_and_conditions_ar;
        this.data.contentEn = res.data.data.terms_and_conditions_en;

        console.log( this.data.contentAr)
        // End:: Set Data
      } catch (error) {
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("terms_and_conditions[ar]", this.data.contentAr);
      REQUEST_DATA.append("terms_and_conditions[en]", this.data.contentEn);
