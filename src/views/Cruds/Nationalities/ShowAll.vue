          ...
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <base-input col="6" type="text" :placeholder="$t('PLACEHOLDERS.nationality')"
                v-model.trim="filterOptions.nationality" />
              <!-- End:: Name Input -->
      ...
      <v-data-table class="thumb" :loading="loading" :loading-text="$t('TABLES.loadingData')" :search="searchValue"
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <template v-if="!permissions.edit && !permissions.destroy">
  ...
  methods: {
    ...
    async setTableRows() {
      ...
      try {
        let res = await this.$axios({
          method: "GET",
          url: "modules/nationality",
          params: {
            page: this.paginations.current_page,
            search: this.filterOptions.nationality,
    ...
    async changeActivationStatus(item) {
      try {
        await this.$axios({
          method: "PUT",
          url: `modules/nationality/${item.id}/activate`,
        });
    ...
    async confirmDeleteItem() {
      try {
        await this.$axios({
          method: "DELETE",
          url: `modules/nationality/${this.itemToDelete.id}`,
        });
