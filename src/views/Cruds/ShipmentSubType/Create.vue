<template>
  <div class="crud_form_wrapper">
    ...
    <div class="form_title_wrapper">
      <h4>{{ $t("PLACEHOLDERS.add_Shipment_sub_type") }}</h4>
    </div>
    <!-- End:: Title -->
    ...
    <div class="single_step_form_content_wrapper">
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <!-- Start:: Name Input -->
          <base-input col="4" type="text" :placeholder="$t('PLACEHOLDERS.Shipment_sub_type_ar')" v-model.trim="data.nameAr" required />
          <!-- End:: Name Input -->

          <!-- Start:: Name Input -->
          <base-input col="4" type="text" :placeholder="$t('PLACEHOLDERS.Shipment_sub_type_en')" v-model.trim="data.nameEn" required />
          <!-- End:: Name Input -->
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("shipment_type_id", this.data.carType.id);
      // Start:: Append Request Data
      ...
      try {
        ...
        this.$router.push({ path: "/shipment-sub-type/all" });
      } catch (error) {
        this.isWaitingRequest = false;
