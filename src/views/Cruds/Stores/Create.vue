    ...
    <div class="single_step_form_content_wrapper">
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <!-- Start:: Phone Input -->
          <base-input col="4" type="tel" :placeholder="$t('PLACEHOLDERS.phoneNumber')" v-model.trim="data.phone"
            required />
          <!-- End:: Phone Input -->
          ...
          <v-container class="px-0 custom_labels">
            <div class="form-group" v-for="(day, index) in daying" :key="'w' + index">
          ...
          <div class="row">
            ...
            <div class="all_row_input w-100" v-for="(day, index) in daying" :key="'day' + index">
              <div v-if="day.isChecked" class="w-100">
                <h3 class="text-center head_section">{{ $t('TABS.work_times') }} {{ day.name }}</h3>

                <div class="w-100  d-flex loop_working" v-for="(workingHour, hourIndex) in  day.working_hours"
                  :key="hourIndex">
