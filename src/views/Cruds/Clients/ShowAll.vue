        ...
        <div class="filter_form_wrapper">
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <!-- Start:: email Input -->
              <base-input col="3" type="tel" :placeholder="$t('PLACEHOLDERS.email')" v-model.trim="filterOptions.email" />
              <!-- End:: email Input -->
  ...
  methods: {
    ...
    async HandlingItemActivationStatus(selectedItem) {
      ...
      try {
        await this.$axios({
          method: "PUT",
          url: `modules/client/activate/${targetItem.user.id}?account_status=${this.status_now}`,
